      ...
      function admissionvalidate(){
       ...
       // var spaceregx=/^([a-zA-Z]+)\s{3}?$/;
        ...
        if(admission.trim()==""){
          ...
          document.getElementsByClassName("preschoolname").focus();
          return false;
        }
          ...
          document.getElementsByClassName("preschoolleave").focus();
          return false;
        }
          ...
          document.getElementsByClassName("specialneedremark").focus();
          return false;
        }
...
<div class="admission_body">
      ...
      <form onsubmit="return admissionvalidate()" action="#" >
        <div class="topadmissioncontainer">
          <div class="main-user-info">
            <div class="user-input-box">
              <label for="academicy">Academic Year <span class="astrix_sign">&#42;</span></label>
              <select name="academicy" id="academicy">
        ...
        <div class="admissioncontainer">
          <div class="logintitle"><span>Upload Documents</span></div>
          <div class="main-user-info">
            <div class="file-box">
              <label for="photo"
        ...
        <div class="admissioncontainer">
          ...
          <div class="main-user-info">
            ...
            <div class="user-input-box">
              ...
              <select name="preschoolclass" id="preschoolclass">
                <option value="">-Select Class-</option>
                  <option value="nursery">Nursery</option>
                  <option value="jrkg">JR KG</option>
                  <option value="srkg">SR KG</option>
        ...
        <div class="admissioncontainer">
          ...
          <div class="main-user-info">
            <span class="disability-details-box">
              <span class="disability-title">Any Learning Disablity <span class="astrix_sign" style="color:red">&#42;</span></span>
              <div class="disability-category">
                <input type="radio" name="learning_disablity" id="dyes" />
                <label for="male">Yes</label>
                <input type="radio" name="learning_disablity" id="dno" />
                <label for="female">No</label>
              </div>
            </span>
            <span class="disability-details-box">
              <span class="disability-title">Physically Challenged <span class="astrix_sign" style="color:red">&#42;</span></span>
              <div class="disability-category">
                <input type="radio" name="physically_challenged" id="pyes" />
                <label for="male">Yes</label>
                <input type="radio" name="physically_challenged" id="pno" />
                <label for="female">No</label>
              </div>
            </span>
            <span class="disability-details-box">
              <span class="disability-title">Mentally Challenged <span class="astrix_sign" style="color:red">&#42;</span></span>
              <div class="disability-category">
                <input type="radio" name="mentally_challenged" id="myes" />
                <label for="male">Yes</label>
                <input type="radio" name="mentally_challenged" id="mno" />
                <label for="female">No</label>
              </div>
            </span>
            <div class="user-input-box">
