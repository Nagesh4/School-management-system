		...
		<div class="container text-center text-md-left">
			<div class="row text-center text-md-left">
				<div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
					<h5 class="text-uppercase mb-4 font-weight-bold text-warning">Comapany Name</h5>
					<p>Here you can use rows and colums to organize your footer content. Lorem ipsum dolor sit amet,
					ital consectetur lorem ipsum dolor sit amet adipiscing elit</p>
				</div>
				<div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
					<h5 class="text-uppercse mb-4 font-weight-bold text-warning">Products</h5>
					<p>
